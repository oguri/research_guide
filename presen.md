...
* 図について、聴衆に内容を伝えやすくする工夫として、縦軸横軸のラベルや図中の線、点などのすぐそばに簡潔な言葉でその意味や説明を書く、というテクニックもあるので検討してください。例えば図にいくつかの線が違う色である場合、論文の図では凡例として図のどこかにまとめて示されるのが通例ですが、(状況にもよりますが) プレゼンでは凡例の代わりにそれぞれの線のすぐそばに同じ色で線の説明を書くと格段に見やすくなることも多いです。
